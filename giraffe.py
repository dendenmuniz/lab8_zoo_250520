...
class Giraffe(Herbivore):
    actions = [
            {"behavior": "stretches its neck to reach the tallest leaves.", "energy": "+", "value": 4},
    ...
    def __init__(self, name, age, energy_level, favorite_food):
        super().__init__(name, age, "giraffe", energy_level, favorite_food, 8, "snort")
    ...
    def be_feed(self):
        self.energy_level += 1
        print(f"{self.name} gently pulls leaves from their hand with a long, purple tongue.")
